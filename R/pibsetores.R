#' PIB setorial do Brasil
#' 
#' Dados contem as series das contas trimestrais do PIB setorial de 1996Q1 ate 
#' 2016Q3. Valores encadeados a preco de 1995 (1.000.000 Reais)
#' 
#' @usage pibsetores
#' 
